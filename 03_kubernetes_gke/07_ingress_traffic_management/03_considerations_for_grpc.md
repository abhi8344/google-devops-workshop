...
#### 4. Download Istio & Helm Cli Tools
...
#### 5. Install Istio onto the Cluster
...
#### 7. Create a namespace for your application, could be default
...
#### 8. Build the gRPC sample app server Docker image
...
#### 9. Deploy the sample app server
...
#### 11. Build the gRPC sample app client Docker image
...
or, you can use the pre-built image on redaptcloud dockerhub: `redaptcloud/grpc-greeter-go-client`

#### 12. Verify that gRPC Load Balancing is taking place, by launching our client in the istio-system namespace and referencing its secret for TLS
